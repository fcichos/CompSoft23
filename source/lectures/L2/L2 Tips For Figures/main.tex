...
\title{Example Manuscript for Figure Demonstration} % The article title

\author{
	\authorstyle{Frank Cichos\textsuperscript{1,2,3} and Py Ton\textsuperscript{2,3}} % Authors
	\newline\newline % Space before institutions
	\textsuperscript{1}\institution{Molecular Nanophotonics Group, Leipzig University, Leipzig, Germany}\\ % Institution 1
	\textsuperscript{2}\institution{Leipzig Zoo, Leipzig, Germany}\\ % Institution 2
...
\begin{figure}
    ...
    \includegraphics[width=\linewidth]{figure 1.pdf} % Figure image
